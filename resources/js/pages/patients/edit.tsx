                    ...
                    <div className="flex items-center space-x-3">
                        ...
                        <div>
                            ...
                            <p className="text-gray-600 dark:text-gray-400">
                                Perbarui informasi {patient.nama}
                            </p>
                        </div>
                    </div>
                        ...
                        <div className="grid gap-6 md:grid-cols-2">
                            ...
                            <div className="md:col-span-2">
                                ...
                                <div className="mt-1 flex items-start space-x-2">
                                    <span className="text-red-500 pt-2">⚠️</span>
                                    <textarea
                                        id="alergi"
                                        rows={2}
                                        value={data.alergi}
                                        onChange={(e) => setData('alergi', e.target.value)}
                                        className="flex-1 rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:focus:border-blue-500"
